...
class IndexIdentificationsRequest extends Request
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'reservable_stock_type' => ['nullable', Rule::in(\App\Enums\Params\Item\Stock::getValues())],
            ...
            'last_added_stock_date_from' => 'nullable|date',
            'last_added_stock_date_to' => 'nullable|date',
    ...
    public function attributes()
    {
        return [
            ...
            'reservable_stock_type' => __('validation.attributes.item_detail_identification.reservable_stock'),
            ...
            'last_added_stock_date_from' => __('validation.attributes.last_added_stock_date'),
            'last_added_stock_date_to' => __('validation.attributes.last_added_stock_date'),
