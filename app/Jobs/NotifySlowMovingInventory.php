...
use App\Mail\SlowMovingInventory as SlowMovingInventoryMail;
...
class NotifySlowMovingInventory implements ShouldQueue
{
    use Dispatchable;
    ...
    public function handle(
        ...
        $mail = new SlowMovingInventoryMail($data);
